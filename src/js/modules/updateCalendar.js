...
export default function updateCalendar(dateFrom, dateTo, submited = true, submited2 = true)
{
    ...
    let day = 1;
    let day1 = 1;
    const firstDayWeek = new Date(Date.UTC(dateFrom.getFullYear(), dateFrom.getMonth(), 0));
    const firstDayWeek1 = new Date(Date.UTC(dateTo.getFullYear(), dateTo.getMonth(), 0));
    ...
    {
        i++;
        daysInMonth(dateTo.getFullYear(), dateTo.getMonth() + 1) + firstDayWeek1.getDay() + 1 && i > firstDayWeek1.getDay()
