...
let dateFrom = new Date(Date.UTC(1999, 9, 1));
let dateTo = new Date(Date.UTC(1999, 10, 1));
flsFunctions.isWebp();
...
document.getElementById('date-input-2').addEventListener('change', function (e) {
    ...
    {
        document.getElementById('error-message-2').textContent = 'Неправильная длина строки';
    }
    else if(enteredDate == "Invalid Date")
    {
